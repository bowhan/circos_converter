...
(function ($) {
    ...
    BioCircos = function () {
        ...
        self.settings = {
            ...
            "outerRadius": 270,
            "zoom": false,
            "genomeFillColor": ["rgb(153,102,0)", "rgb(102,102,0)", "rgb(153,153,30)", "rgb(204,0,0)", "rgb(255,0,0)",
                                "rgb(255,0,204)", "rgb(255,204,204)", "rgb(255,153,0)", "rgb(255,204,0)",
                                "rgb(255,255,0)", "rgb(204,255,0)", "rgb(0,255,0)", "rgb(53,128,0)", "rgb(0,0,204)",
                                "rgb(102,153,255)", "rgb(153,204,255)", "rgb(0,255,255)", "rgb(204,255,255)",
                                "rgb(153,0,204)", "rgb(204,51,255)", "rgb(204,153,255)", "rgb(102,102,102)",
    ...
    BioCircos.prototype.draw_genome = function (genome) {
        ...
        var width = self.svgWidth, height = self.svgHeight, innerRadius = self.innerRadius, outerRadius = self.outerRadius;
        ...
        if (self.genomeTextDisplay == true) {
            svg.append("g").selectAll("text")
               ...
               .attr("transform", function (d) {
                   return "rotate(" + ( d.angle * 180 / Math.PI ) + ")" + "translate(0," + -1.0 * (outerRadius + 10) + ")" + ( ( d.angle > Math.PI * 2 && d.angle < Math.PI * 0 ) ? "rotate(180)" : "");
               })
               .text(function (d) {
                   return d.name;
               });
            ...
            for (var linki = 0; linki < self.LINK.length; linki++) {
                ...
                if (self.LINKsettings.displayLinkLabel == true) {
                    svg.append("g")
                       ...
                       .enter().append("text")
                       .attr("transform", function (d) {
                           return "rotate(" + (d.link_angle2 * 180 / Math.PI - 90) + ")" + "translate(" + (self.LINKsettings.LinkRadius + self.LINKsettings.LinkAxisPad) + ",0)";
                       })
                       .attr("class", "BioCircosLINKLabel")
